            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\HtxController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\HtxController@index') !!}">
                                {!! csrf_field() !!}
                            ...
                            <tbody>
                                @foreach( $htxes as $htx )
                                    <tr>
                                        <td>{{ $htx->id }}</td>
                                                                                <td>
                                            <a href="{!! action('Admin\HtxController@show', $htx->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\HtxController@destroy', $htx->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
