            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\UnitController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\UnitController@index') !!}">
                                {!! csrf_field() !!}
                            ...
                            <tbody>
                                @foreach( $units as $unit )
                                    <tr>
                                        ...
                                        <td>{{ $unit->name }}</td>
                                        <td>
                                            <a href="{!! action('Admin\UnitController@show', $unit->id) !!}" class="btn btn-outline-primary btn-sm m-btn m-btn--icon">
                                                <span>
                                                    <i class="fa fa-edit"></i>
                                                    <span>Sửa</span>
                                                </span>
                                            </a>
                                            <a href="#" data-delete-url="{!! action('Admin\UnitController@destroy', [$unit->id]) !!}" class="btn btn-outline-primary btn-sm m-btn m-btn--icon">
                                                <span>
