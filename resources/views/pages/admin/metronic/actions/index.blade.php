@extends('pages.admin.metronic.layout.application',['menu' => 'actions'] )
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\ActionController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\ActionController@index') !!}">
                                {!! csrf_field() !!}
                            ...
                            <thead>
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('name', trans('admin.pages.actions.columns.name')) !!}</th>
                            ...
                            <tbody>
                                @foreach( $actions as $action )
                                    <tr>
                                        ...
                                        <td>{{ $action->name }}</td>
                                        <td>
                                            <a href="{!! action('Admin\ActionController@show', $action->id) !!}" class="btn btn-outline-primary btn-sm m-btn m-btn--icon">
                                                <span>
                                                    <i class="fa fa-edit"></i>
                                                    <span>Sửa</span>
                                                </span>
                                            </a>
                                            <a href="#" data-delete-url="{!! action('Admin\ActionController@destroy', [$action->id]) !!}" class="btn btn-outline-primary btn-sm m-btn m-btn--icon">
                                                <span>
